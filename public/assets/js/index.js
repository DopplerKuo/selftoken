  ...
  watch: {
    lang: function(val) {
      if (val === 'tc') {
        ...
        this.sec2Dsc1 =
          '未來看電影時我們將不再使用電影票，而是獨一無二的電影代幣，一個可以讓人人成為電影的支持者、推廣者、獲益者並入場觀影的電影區塊鏈加密代幣，而 SELF TOKEN 將會是這個自生態代幣的領航者。';
        ...
        this.sec2Dsc3 =
          '我們將以食、衣、住、行、育、樂六大面向簽訂合作品牌，支持娛樂上的多元支付，並設立直營之多元娛樂場域（如 SELF BAR、SELF CAFE、電影場景轉營運之共創空間 SELF SPACE 等）。';
        this.sec2Title4 = '全透明的影視生態系獎勵';
        this.sec2Dsc4 =
          '我們將把電影的票房、直營店之營收以及其他相關之營銷盈餘轉成Ether或是其他數位加密貨幣，作為獎勵予以所有支持、使用 SELF TOKEN 消費的使用者，而首次的獎勵將會由電影聖人大盜之 100% 票房營收作爲基礎。';
        this.sec2Title5 = '全球流通的應用代幣';
        this.sec2Dsc5 =
          '除了作爲應用代幣之外，我們將跟交易所進行合作，成為可在全球流通、自由交易的 SELF 幣。';
        this.sec2Title6 =
          '讓人人都可以是電影娛樂生態中推廣者、支持者、觀眾、受益者，創造一個共好的娛樂生態系。';
