  ...
  watch: {
    lang: function(val) {
      if (val === 'tc') {
        ...
        this.sec4p8 =
          '电影圣人大盗进入 60 天拍摄期、SELF TOKEN 进入商转前技术开发。 ';
        this.sec4p9 =
          '电影正式预告上线、SELFTOKEN 上线合作交易所。后续进程请详参白皮书。 ';
        ...
        this.sec5name11 = '曾志伟';
        this.sec5title11 = 'SELF 原创电影圣人大盗监制';
        ...
        this.sec5name12 = '叶如芬';
        this.sec5title12 = 'SELF 原创电影圣人大盗监制';
        ...
        this.sec5name13 = '杨子朴';
        this.sec5title13 = 'SELF 原创电影圣人大盗音乐总监';
