		...
		function moveSomething(something) {
			...
			if ( something === '.color-bg' ) {
				...
				if ( scrollPercent >= 0 ) {
					...
					$('.bg-img-box:nth-of-type(1) img').css('transform', 'translate3d(0, 0, 0)');	
					$('header').addClass('ani');
				}
				if ( scrollPercent >= 0 ) {
				...
				if ( scrollPercent >= 0.15 * height - screenHeight / 2) {
					...
					$('.bg-img-box:nth-of-type(4) img').css('transform', 'translate3d(0, 0, 0)');	
				}
				if ( scrollPercent >= 0.16 * height - screenHeight / 2) {
					$('.bg-img-box:nth-of-type(5) img').css('opacity', '0.6');	
					$('.bg-img-box:nth-of-type(5) img').css('transform', 'translate3d(0, 0, 0)');	
				}
				...
				if ( scrollPercent >= 0.42 * height - screenHeight / 2) {
					...
					$('.bg-img-box:nth-of-type(8) img').css('transform', 'translate3d(0, 0, 0)');	
				}
				if ( scrollPercent >= 0.46 * height - screenHeight / 2) {
					$('.bg-img-box:nth-of-type(9) img').css('opacity', '0.4');	
					$('.bg-img-box:nth-of-type(9) img').css('transform', 'translate3d(0, 0, 0)');	
				}
				if ( scrollPercent >= 0.55 * height - screenHeight / 2) {
					$('.bg-img-box:nth-of-type(10) img').css('opacity', '1');
					$('.bg-img-box:nth-of-type(10) img').css('transform', 'translate3d(0, 0, 0)');
				}
				if ( scrollPercent >= 0.65 * height - screenHeight / 2) {
					$('.bg-img-box:nth-of-type(11) img').css('opacity', '1');
					$('.bg-img-box:nth-of-type(11) img').css('transform', 'translate3d(0, 0, 0)');
				}
				if ( scrollPercent >= 0.77 * height - screenHeight / 2) {
					$('.bg-img-box:nth-of-type(12) img').css('opacity', '1');
					$('.bg-img-box:nth-of-type(12) img').css('transform', 'translate3d(0, 0, 0)');
				}
				if ( scrollPercent >= 0.80 * height - screenHeight / 2) {
					$('.bg-img-box:nth-of-type(13) img').css('opacity', '1');
					$('.bg-img-box:nth-of-type(13) img').css('transform', 'translate3d(0, 0, 0)');
				}
				if ( scrollPercent >= 0.80 * height - screenHeight / 2) {
					$('.bg-img-box:nth-of-type(14) img').css('opacity', '1');
					$('.bg-img-box:nth-of-type(14) img').css('transform', 'translate3d(0, 0, 0)');
				}
			}
